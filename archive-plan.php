...
?>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="page-links">
      <h2 class="page-links__title">Plan Branches</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
       ...
       while($PlanPosts->have_posts()){
		...
		?>
                    ...
                    <td align="center"><a href="<?php echo site_url('branch-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">(<?php echo the_field('no_branches'); ?>)Edit</a></td>
					<td align="center"><a href="<?php echo site_url('branch-not-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit</a></td>
