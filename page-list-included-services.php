...
?>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="page-links">
      <h2 class="page-links__title">Included Services</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
 		...
 		<?php
		echo '<tr bgcolor="#CCCCCC" style="font-weight:bold" ><td>Plan Name</td><td>Product</td><td>Status</td><td align="center">On</td><td align="center">Off</td></tr>';
       ...
       while($PlanPosts->have_posts()){
		...
		?>
                    ...
                    <td align="center"><a href="<?php echo site_url('included-services-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">(<?php echo the_field('no_services'); ?>)Edit</a></td>
					<td align="center"><a href="<?php echo site_url('included-services-not-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit</a></td>
