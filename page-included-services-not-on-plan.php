...
?>
  <div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      <h1 class="page-banner__title">Services not on Plan</h1>
...
._errors {
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('plans/?ID=' . $client_id . '&ClientName=' . $ClientName); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to All Plans</a> <span class="metabox__main">Services Not On <?php echo $plan_name ?></span></p>
    </div>
	<form id="theForm" name="theForm" action="<?php echo site_url('save-included-service-not-on-plan'); ?>" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr bgcolor="#D8EBED">
    <td width="4%">&nbsp;</td>
    <td colspan="9"><span class="_fields">Services not on <?php echo $plan_name?></span></td>
	<td width="90%">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" class="_profavailable">Services not on <?php echo $plan_name?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><span class="_profavailable">Services to add to <?php echo $plan_name?></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
