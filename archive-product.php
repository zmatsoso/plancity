 ...
 get_header(); ?>
  ...
  <div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      <h1 class="page-banner__title">Product List</h1>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('monty'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Main Menu</a> <span class="metabox__main">Plans</span></p>
    </div>
	
	<div class="container">
	<nav class="codrops-demos">
					<a href="<?php echo site_url('new-product'); ?>">New Product</a>
	<nav>
	<br>	
	</div>	
		...
		?>
                    ...
                    <td><a href="<?php echo site_url('list-plans'); ?>">View</a>
                    </td>
