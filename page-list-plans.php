...
?>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="page-links">
      <h2 class="page-links__title">Plan List</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
	           ...
	           <nav class="codrops-demos">
					<a href="<?php echo site_url('new-plan/?ID=' . $client_id . '&ClientName=' . $ClientName); ?>">New Plan</a>
  	...
  	<br>	
       ...
       while($PlanPosts->have_posts()){
		...
		?>
                    ...
                    <td align="center"><a href="<?php echo site_url('edit-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit Plan</a></td>
			        </tr>
