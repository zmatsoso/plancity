...
?>
  ...
  <div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      <h1 class="page-banner__title">Premium</h1>
...
<script>
 function do_cancel(){
	 if(confirm('Are you sure you want to cancel?'))
		 window.location.replace(`<?php echo site_url('edit-premiums/?ID=' . $client_id . '&PlanId=' . $plan_id); ?>`);
 }	 
</script>
<style>
...
document.getElementById('submit').click();
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('edit-premiums/?ID=' . $client_id . '&PlanId=' . $plan_id); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Premiums</a> <span class="metabox__main">Benefits</span></p>
    </div>
	
<form id="theForm" name="theForm" action="<?php echo site_url('save-edit-single-premium'); ?>" method="post">
<table width="100%" cellspacing="0" cellpadding="5">
  <tr>
    <td width="91%"><span class="new_role">Edit Premiums for <?php echo $business_name?>, <?php echo $Age_title; ?> Years</span></td>
    <td width="9%">&nbsp;</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr bgcolor="#D8EBED">
    <td width="4%">&nbsp;</td>
    <td colspan="9"><span class="_fields">Premiums</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td width="21%">&nbsp;</td>
   ...
   <tr>
    ...
    <td width="80%"><input type="text" name="amount" id="amount" value="<?php echo $amount?>"/></td>
