...
?>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="page-links">
      <h2 class="page-links__title">Optional Services</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
 		...
 		<?php
		echo '<tr bgcolor="#CCCCCC" style="font-weight:bold" ><td>Plan Name</td><td>Product</td><td>Status</td><td align="center">On</td><td align="center">Off</td><td align="center">Tarrif</td></tr>';
       ...
       while($PlanPosts->have_posts()){
		...
		?>
                    ...
                    <td align="center"><a href="<?php echo site_url('optional-services-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">(<?php echo the_field('no_optionals'); ?>)Edit</a></td>
					<td align="center"><a href="<?php echo site_url('optional-services-not-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit</a></td>
					<td align="center"><a href="<?php echo site_url('list-optional-tariffs/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit</a></td>
