...
?>
  ...
  <div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      <h1 class="page-banner__title">Benefits</h1>
...
document.getElementById('submit').click();
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('list-plan-benefits/?ID=' . $client_id . '&PlanId=' . $plan_id); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Services</a> <span class="metabox__main">Benefits</span></p>
    </div>
	
<form id="theForm" name="theForm" action="<?php echo site_url('save-edit-benefits'); ?>" method="post">
<table width="100%" cellspacing="0" cellpadding="5">
  <tr>
    <td width="91%"><span class="new_role">Edit Service Benefits for <?php echo $Service_title?>, <?php echo $plan_name?> Plan</span></td>
    <td width="9%">&nbsp;</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td colspan="2" class="_headings"><?php echo $Service_title?></td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr bgcolor="#D8EBED">
    <td width="4%">&nbsp;</td>
    <td colspan="9"><span class="_fields">Amount / (Yes/No)</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td width="21%">&nbsp;</td>
