...
?>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="page-links">
      <h2 class="page-links__title">Additional Dependents</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
	   ...
	   <table border="0" cellpadding="5px" cellspacing="1px" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; background-color:#E1E1E1" width="60%">
 		<?php
		echo '<tr bgcolor="#CCCCCC" style="font-weight:bold" ><td>Plan Name</td><td>Product</td><td>Status</td><td align="center">On</td><td align="center">Off</td><td align="center">Cost</td></tr>';
       ...
       while($PlanPosts->have_posts()){
		$PlanPosts->the_post(); 
			$Additional_members = get_field('additional_members');
		...
		?>
                    ...
                    <td align="center"><a href="<?php echo site_url('add-members-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">(<?php echo $add_member; ?>)Edit</a></td>
					<td align="center"><a href="<?php echo site_url('add-members-not-on-plan/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit</a></td>

					<td align="center"><a href="<?php echo site_url('edit-add-members-cost/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">Edit</a></td>
