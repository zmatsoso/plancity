...
get_header(); ?>
  ...
  <div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      <h1 class="page-banner__title">New Area</h1>
...
document.getElementById('submit').click();
  ...
  <form id="theForm" name="theForm" action="<?php echo site_url('save-area'); ?>" method="post">
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    ...
    <td width="80%"><input type="text" name="area_name" id="area_name" value="" required/></td>
  </tr>
  <tr>
    <td width="4%">&nbsp;</td>
    <td width="16%" class="_fields">Latitude</td>
    <td width="80%"><input type="text" name="latitude" id="latitude" value="" required/></td>
  </tr>
  <tr>
    <td width="4%">&nbsp;</td>
    <td width="16%" class="_fields">Longitude</td>
    <td width="80%"><input type="text" name="longitude" id="longitude" value="" required/></td>
  </tr>
