...
?>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('clients'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Clients</a> <span class="metabox__main">Waiting Periods</span></p>
    </div>
    
    <div class="page-links">
      <h2 class="page-links__title">Waiting Periods</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
       ...
       while($PlanPosts->have_posts()){
		...
		?>
					...
					<td align="center"><a href="<?php echo site_url('list-waiting-periods/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">List</a></td>
