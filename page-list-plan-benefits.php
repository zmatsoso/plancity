...
?>
  ...
  <div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      <h1 class="page-banner__title">Plan Benefits</h1>
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('clients'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Clients</a> <span class="metabox__main">Plan Benefits</span></p>
    </div>
    
    <div class="page-links">
      <h2 class="page-links__title">Plan Benefits</h2>
      <ul class="min-list">
    ...
    <div class="generic-content">
 		...
 		<?php
		echo '<tr bgcolor="#CCCCCC" style="font-weight:bold" ><td>Plan Name</td><td>Product</td><td>Status</td><td align="center">Options</td></tr>';
       ...
       while($PlanPosts->have_posts()){
		...
		?>
					...
					<td align="center"><a href="<?php echo site_url('list-benefits/?ID=' . $client_id . '&PlanId=' . get_the_ID()); ?>">List</a></td>
