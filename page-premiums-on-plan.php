...
?>
                ...
                '<?php echo $Age_ID3?> = R <?php echo $amount?>',   
...
._errors {
  ...
  <div class="container container--narrow page-section">
    ...
    <div class="metabox metabox--position-up metabox--with-home-link">
      <p><a class="metabox__blog-home-link" href="<?php echo site_url('edit-premiums/?ID=' . $client_id . '&PlanId=' . $plan_id); ?>"><i class="fa fa-home" aria-hidden="true"></i> Back to Premiums</a> <span class="metabox__main">Ages Not On <?php echo $plan_name ?></span></p>
    </div>
<form id="theForm" name="theForm" action="<?php echo site_url('save-premiums-on-plan'); ?>" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
 ...
 <tr>
    ...
    <td width="4%">&nbsp;</td>
    <td width="17%" align="right" class="_all_text"> New Premium:</td>
